...
# module references:
# gpio_mmio, mmio_decode_ram_gpio, pc_to_rom_addr, pc_unit, rv32i_alu, rv32i_control_full, rv32i_decoder, rv32i_imm_mux, rv32i_opA_mux, rv32i_opB_mux, rv32i_pc_redirect, rv32i_ram_datav, rv32i_regfile, rv32i_wb_mux
...
proc create_root_design { parentCell } {
  ...
  connect_bd_net -net dist_mem_gen_0_spo [get_bd_pins dist_mem_gen_0/spo] [get_bd_pins ila_0/probe7] [get_bd_pins rv32i_decoder_0/instr]
  connect_bd_net -net gpio_mmio_0_gpio_dir [get_bd_pins gpio_mmio_0/gpio_dir] [get_bd_pins ila_0/probe1]
  connect_bd_net -net gpio_mmio_0_gpio_out [get_bd_pins gpio_mmio_0/gpio_out] [get_bd_pins ila_0/probe0]
  connect_bd_net -net gpio_mmio_0_mem_rdata [get_bd_pins gpio_mmio_0/mem_rdata] [get_bd_pins mmio_decode_ram_gpio_0/gpio_rdata]
  connect_bd_net -net gpio_mmio_0_mem_ready [get_bd_pins gpio_mmio_0/mem_ready] [get_bd_pins ila_0/probe4]
  connect_bd_net -net mmio_decode_ram_gpio_0_fault_access [get_bd_pins ila_0/probe3] [get_bd_pins mmio_decode_ram_gpio_0/fault_access]
  connect_bd_net -net mmio_decode_ram_gpio_0_gpio_addr [get_bd_pins gpio_mmio_0/mem_addr] [get_bd_pins mmio_decode_ram_gpio_0/gpio_addr]
  connect_bd_net -net mmio_decode_ram_gpio_0_gpio_en [get_bd_pins gpio_mmio_0/mem_valid] [get_bd_pins mmio_decode_ram_gpio_0/gpio_en]
  connect_bd_net -net mmio_decode_ram_gpio_0_gpio_wdata [get_bd_pins gpio_mmio_0/mem_wdata] [get_bd_pins mmio_decode_ram_gpio_0/gpio_wdata]
  connect_bd_net -net mmio_decode_ram_gpio_0_gpio_we [get_bd_pins gpio_mmio_0/mem_we] [get_bd_pins mmio_decode_ram_gpio_0/gpio_we]
  connect_bd_net -net mmio_decode_ram_gpio_0_load_data [get_bd_pins mmio_decode_ram_gpio_0/load_data] [get_bd_pins rv32i_wb_mux_0/load_data]
  ...
  connect_bd_net -net mmio_decode_ram_gpio_0_ram_be [get_bd_pins mmio_decode_ram_gpio_0/ram_be] [get_bd_pins rv32i_ram_datav_0/be]
  connect_bd_net -net mmio_decode_ram_gpio_0_ram_en [get_bd_pins ila_0/probe2] [get_bd_pins mmio_decode_ram_gpio_0/ram_en]
  ...
  connect_bd_net -net mmio_decode_ram_gpio_0_ram_we [get_bd_pins mmio_decode_ram_gpio_0/ram_we] [get_bd_pins rv32i_ram_datav_0/we]
  connect_bd_net -net pc_to_rom_addr_0_a [get_bd_pins dist_mem_gen_0/a] [get_bd_pins ila_0/probe8] [get_bd_pins pc_to_rom_addr_0/a]
  connect_bd_net -net pc_unit_0_pc [get_bd_pins pc_to_rom_addr_0/pc] [get_bd_pins pc_unit_0/pc] [get_bd_pins rv32i_opA_mux_0/pc] [get_bd_pins rv32i_pc_redirect_0/pc]
  connect_bd_net -net pc_unit_0_pc_plus4 [get_bd_pins pc_unit_0/pc_plus4] [get_bd_pins rv32i_wb_mux_0/pc_plus4]
  connect_bd_net -net proc_sys_reset_0_peripheral_reset [get_bd_pins gpio_mmio_0/rst] [get_bd_pins ila_0/probe6] [get_bd_pins mmio_decode_ram_gpio_0/rst] [get_bd_pins pc_unit_0/rst] [get_bd_pins proc_sys_reset_0/peripheral_reset]
  connect_bd_net -net rv32i_alu_0_Y [get_bd_pins mmio_decode_ram_gpio_0/addr] [get_bd_pins rv32i_alu_0/Y] [get_bd_pins rv32i_wb_mux_0/alu_y]
  ...
  connect_bd_net -net rv32i_control_full_0_lsu_size [get_bd_pins mmio_decode_ram_gpio_0/lsu_size] [get_bd_pins rv32i_control_full_0/lsu_size]
  connect_bd_net -net rv32i_control_full_0_lsu_unsigned [get_bd_pins mmio_decode_ram_gpio_0/lsu_unsigned] [get_bd_pins rv32i_control_full_0/lsu_unsigned]
  connect_bd_net -net rv32i_control_full_0_mem_re [get_bd_pins mmio_decode_ram_gpio_0/mem_re] [get_bd_pins rv32i_control_full_0/mem_re]
  connect_bd_net -net rv32i_control_full_0_mem_we [get_bd_pins mmio_decode_ram_gpio_0/mem_we] [get_bd_pins rv32i_control_full_0/mem_we]
  ...
  connect_bd_net -net rv32i_decoder_0_imm_i [get_bd_pins rv32i_decoder_0/imm_i] [get_bd_pins rv32i_imm_mux_0/imm_i] [get_bd_pins rv32i_pc_redirect_0/imm_i]
  ...
  connect_bd_net -net rv32i_decoder_0_imm_s [get_bd_pins rv32i_decoder_0/imm_s] [get_bd_pins rv32i_imm_mux_0/imm_s]
  ...
  connect_bd_net -net rv32i_ram_datav_0_rdata [get_bd_pins mmio_decode_ram_gpio_0/ram_rdata] [get_bd_pins rv32i_ram_datav_0/rdata]
  ...
  connect_bd_net -net rv32i_regfile_0_rs2_rdata [get_bd_pins mmio_decode_ram_gpio_0/store_data] [get_bd_pins rv32i_opB_mux_0/rs2] [get_bd_pins rv32i_pc_redirect_0/rs2] [get_bd_pins rv32i_regfile_0/rs2_rdata]
  ...
  connect_bd_net -net xlconstant_4_dout [get_bd_pins gpio_mmio_0/gpio_in] [get_bd_pins xlconstant_4/dout]
  connect_bd_net -net zynq_ultra_ps_e_1_pl_clk0 [get_bd_pins gpio_mmio_0/clk] [get_bd_pins ila_0/clk] [get_bd_pins mmio_decode_ram_gpio_0/clk] [get_bd_pins pc_unit_0/clk] [get_bd_pins proc_sys_reset_0/slowest_sync_clk] [get_bd_pins rv32i_ram_datav_0/clk] [get_bd_pins rv32i_regfile_0/clk] [get_bd_pins zynq_ultra_ps_e_1/maxihpm0_fpd_aclk] [get_bd_pins zynq_ultra_ps_e_1/pl_clk0]
  connect_bd_net -net zynq_ultra_ps_e_1_pl_resetn0 [get_bd_pins ila_0/probe5] [get_bd_pins proc_sys_reset_0/ext_reset_in] [get_bd_pins zynq_ultra_ps_e_1/pl_resetn0]
