...
HD_PWD='/media/steckler/xilinx_linux/SDR_custom/SDR/Software/SDR_Firmware/CPU_N1_ONECYCLE_RISCV_2020.1_MYIR/CPU_V1/CPU_V1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Sections_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Sections_wrapper.tcl -notrace
