...
################################################################
# This is a generated script based on design: Section_debug
#
...
# source Section_debug_script.tcl


# The design that will be created by this Tcl script contains the following 
# module references:
# pc_to_rom_addr, pc_unit, rv32i_decoder
...
proc create_root_design { parentCell } {
  ...
  set_property -dict [ list \
   ...
   CONFIG.Byte_Size {9} \
   CONFIG.Coe_File {../../../../../../../../rv32i_vscode/prog.coe} \
  ...
  connect_bd_net -net blk_mem_gen_0_douta [get_bd_pins blk_mem_gen_0/douta] [get_bd_pins ila_0/probe0] [get_bd_pins rv32i_decoder_0/instr]
  connect_bd_net -net pc_to_rom_addr_0_a [get_bd_pins blk_mem_gen_0/addra] [get_bd_pins ila_0/probe1] [get_bd_pins pc_to_rom_addr_0/a]
  connect_bd_net -net pc_unit_0_pc [get_bd_pins pc_to_rom_addr_0/pc] [get_bd_pins pc_unit_0/pc]
  connect_bd_net -net proc_sys_reset_0_peripheral_reset [get_bd_pins proc_sys_reset_0/peripheral_reset] [get_bd_pins util_vector_logic_0/Op2]
  connect_bd_net -net rv32i_decoder_0_funct3 [get_bd_pins ila_1/probe4] [get_bd_pins rv32i_decoder_0/funct3]
  connect_bd_net -net rv32i_decoder_0_funct7 [get_bd_pins ila_1/probe5] [get_bd_pins rv32i_decoder_0/funct7]
  connect_bd_net -net rv32i_decoder_0_opcode [get_bd_pins ila_1/probe3] [get_bd_pins rv32i_decoder_0/opcode]
  connect_bd_net -net rv32i_decoder_0_rd [get_bd_pins ila_1/probe2] [get_bd_pins rv32i_decoder_0/rd]
  connect_bd_net -net rv32i_decoder_0_rs1 [get_bd_pins ila_1/probe0] [get_bd_pins rv32i_decoder_0/rs1]
  connect_bd_net -net rv32i_decoder_0_rs2 [get_bd_pins ila_1/probe1] [get_bd_pins rv32i_decoder_0/rs2]
  connect_bd_net -net util_vector_logic_0_Res [get_bd_pins ila_0/probe3] [get_bd_pins pc_unit_0/rst] [get_bd_pins util_vector_logic_0/Res]
  ...
  connect_bd_net -net xlconstant_1_dout [get_bd_pins pc_unit_0/pc_redirect_valid] [get_bd_pins xlconstant_1/dout]
  connect_bd_net -net xlconstant_2_dout [get_bd_pins pc_unit_0/pc_redirect_target] [get_bd_pins xlconstant_2/dout]
  connect_bd_net -net xlconstant_3_dout [get_bd_pins blk_mem_gen_0/ena] [get_bd_pins pc_unit_0/pc_en] [get_bd_pins xlconstant_3/dout]
  connect_bd_net -net zynq_ultra_ps_e_1_pl_clk0 [get_bd_pins blk_mem_gen_0/clka] [get_bd_pins ila_0/clk] [get_bd_pins ila_1/clk] [get_bd_pins pc_unit_0/clk] [get_bd_pins proc_sys_reset_0/slowest_sync_clk] [get_bd_pins vio_0/clk] [get_bd_pins zynq_ultra_ps_e_1/maxihpm0_fpd_aclk] [get_bd_pins zynq_ultra_ps_e_1/pl_clk0]
  connect_bd_net -net zynq_ultra_ps_e_1_pl_clk1 [get_bd_pins ila_0/probe2] [get_bd_pins zynq_ultra_ps_e_1/pl_clk1]
