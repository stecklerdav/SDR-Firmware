...
HD_PWD='/media/steckler/xilinx_linux/SDR_custom/SDR/Software/SDR_Firmware/CPU_N1_ONECYCLE_RISCV_2020_1_MYIR_BRAM_DP/CPU_V1/CPU_V1.runs/Section_debug_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Section_debug.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Section_debug.tcl
