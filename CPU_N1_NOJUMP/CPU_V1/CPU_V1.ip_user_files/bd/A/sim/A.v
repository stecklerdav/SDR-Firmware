...
(* CORE_GENERATION_INFO = "A,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=A,x_ipVersion=1.00.a,x_ipLanguage=VERILOG,numBlks=13,numReposBlks=13,numNonXlnxBlks=0,numHierBlks=0,maxHierDepth=0,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=5,numPkgbdBlks=0,bdsource=USER,da_board_cnt=1,da_clkrst_cnt=2,da_ps7_cnt=3,synth_mode=OOC_per_IP}" *) (* HW_HANDOFF = "A.hwdef" *) 
module A
   (DDR_addr,
    DDR_ba,
    DDR_cas_n,
  ...
  A_pc_0_0 pc_0
       (.clk(processing_system7_0_FCLK_CLK0),
        .jump_en(xlconstant_3_dout),
        .jump_offset(xlconstant_4_dout),
        .pc(pc_0_pc),
  ...
  A_xlconstant_2_0 xlconstant_3
       (.dout(xlconstant_3_dout));
  A_xlconstant_3_0 xlconstant_4
