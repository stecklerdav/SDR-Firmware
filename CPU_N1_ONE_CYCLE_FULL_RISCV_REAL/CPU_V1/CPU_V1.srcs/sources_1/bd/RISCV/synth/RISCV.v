...
(* CORE_GENERATION_INFO = "RISCV,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=RISCV,x_ipVersion=1.00.a,x_ipLanguage=VERILOG,numBlks=22,numReposBlks=22,numNonXlnxBlks=0,numHierBlks=0,maxHierDepth=0,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=14,numPkgbdBlks=0,bdsource=USER,da_ps7_cnt=1,synth_mode=OOC_per_IP}" *) (* HW_HANDOFF = "RISCV.hwdef" *) 
module RISCV
   (DDR_addr,
    DDR_ba,
    DDR_cas_n,
  ...
  wire [3:0]rv32i_lsu_0_be;
  wire [31:0]rv32i_lsu_0_load_data;
  ...
  RISCV_rv32i_imm_mux_0_0 rv32i_imm_mux_0
       (.imm_b(rv32i_decoder_0_imm_b),
        ...
        .imm_sel(rv32i_control_full_0_imm_sel),
        .imm_u(rv32i_decoder_0_imm_u));
  RISCV_rv32i_lsu_0_0 rv32i_lsu_0
       (.addr(rv32i_alu_0_Y),
        .be(rv32i_lsu_0_be),
        .is_unsigned(rv32i_control_full_0_lsu_unsigned),
        .load_data(rv32i_lsu_0_load_data),
        .mem_rdata(rv32i_ram_datav_0_rdata),
        .size(rv32i_control_full_0_lsu_size),
  ...
  RISCV_rv32i_ram_datav_0_0 rv32i_ram_datav_0
       (.addr(rv32i_alu_0_Y),
        ...
        .wdata(rv32i_regfile_0_rs2_rdata),
        .we(rv32i_control_full_0_mem_we));
