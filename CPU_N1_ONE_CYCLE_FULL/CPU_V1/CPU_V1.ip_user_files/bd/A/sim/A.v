...
(* CORE_GENERATION_INFO = "A,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=A,x_ipVersion=1.00.a,x_ipLanguage=VERILOG,numBlks=16,numReposBlks=16,numNonXlnxBlks=0,numHierBlks=0,maxHierDepth=0,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=10,numPkgbdBlks=0,bdsource=USER,da_board_cnt=1,da_clkrst_cnt=2,da_ps7_cnt=3,synth_mode=OOC_per_IP}" *) (* HW_HANDOFF = "A.hwdef" *) 
module A
   (DDR_addr,
    DDR_ba,
    DDR_cas_n,
  ...
  A_control_unit_0_0 control_unit_0
       (.alu_op(control_unit_0_alu_op),
        .alu_src_imm(control_unit_0_alu_src_imm),
        .call_en(control_unit_0_call_en),
        .flag_c(alu_0_flag_c),
        .flag_n(alu_0_flag_n),
        .flag_v(alu_0_flag_v),
        .flag_z(alu_0_flag_z),
  ...
  A_pc_0_0 pc_0
       (.clk(processing_system7_0_FCLK_CLK0),
        .pc(pc_0_pc),
        .pc_in(stack_unit_0_pc_out),
        .pc_next(pc_0_pc_next),
        .reset(proc_sys_reset_0_peripheral_reset));
  A_pc_jump_offset_0_0 pc_jump_offset_0
       (.jump_offset(control_unit_0_jump_offset),
        .pc(pc_0_pc),
        .pc_target(pc_jump_offset_0_pc_target));
  ...
  A_stack_unit_0_0 stack_unit_0
       (.call_en(control_unit_0_call_en),
        .clk(processing_system7_0_FCLK_CLK0),
        .jump_en(control_unit_0_jump_en),
        .pc_next(pc_0_pc_next),
        .pc_out(stack_unit_0_pc_out),
        .pc_target(pc_jump_offset_0_pc_target),
        .reset(proc_sys_reset_0_peripheral_reset),
        .ret_en(control_unit_0_ret_en));
  A_uram_0_0 uram_0
